...
public class Parser {
	 ...
	 *
	 * @param validationMode boolean, true to enable validation mode, false to
	 * disable
	 */
	 ...
	 * parsing process and follows the following production: expression -> term
	 * [+term] [-term] term -> factor[*factor] [/factor] factor -> number,
	 * variable, (expression)
	 *
	 ...
	 * production:
	 *
	 * expression -> term [+term] [-term] term -> factor[*factor] [/factor] factor
	...
	/**
	 * Check for plus or minus sign and returns the the result after applying the
	 * sign.
	 *
	...
	/**
	 * Returns the result of evaluating the expression passed as parameter. If
	 * there exists variables in the expression it's assumed that they have been
	 * initialized, e.g. with setVariable(var, val).
	 *
...
/**
 * This class is a wrapper of the java.lang.Math class that provides more
 * additional functionality the the class Parser.
 */
class ExtendedMath {
