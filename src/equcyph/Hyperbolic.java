 ...
 * @author ERC
 */
public class Hyperbolic extends javax.swing.JFrame {
	 ...
	 * @param parent
	 */
	public Hyperbolic(EquCyph parent) {
		initComponents();
		this.parent = parent;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Quadrant (-/+)");

        jLabel5.setText("Horizontal Shift");

        jLabel7.setText("Vertical Shift");
    ...
    private void btnPlotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlotActionPerformed
			String func = "p(x)";
			String head = jTextField1.getText();
